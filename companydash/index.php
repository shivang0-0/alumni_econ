    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <form method="POST" action="../php/companyopp.php">
                        <div class="container">
                            <h1>Post an Opportunity</h1>
                            <p>Please enter the following details to post an opportunity</p>
                            <br>
                            <label><b>Job role</b></label>
                            <input type="text" name="job_role" placeholder="Enter Job role" style="width:300px;" required>
                            <br>
                            <label><b>For passing year</b></label>
                            <input type="number" placeholder="Enter Passing year" name="for_year" required>
                            <br>
                            <label><b>Salary</b></label>
                            <input type="number" placeholder="Enter Salary" name="salary" required>
                            <br>
                            <label><b>Job Description</b></label>
                            <input type="text" placeholder="Enter Job details" name="job_description" required>

                            <br>
                            <label><b>Job Location</b></label>
                            <input type="text" placeholder="Enter Location" name="job_location" required>
                            <br>
                            <div class="clearfix">
